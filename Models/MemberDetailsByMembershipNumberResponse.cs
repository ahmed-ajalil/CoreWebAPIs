...
{
    public class MemberDetailsByMembershipNumberResponse
    {
        public string CompanyCode { get; set; }
        public string MembershipNumber { get; set; }
        public MemberProfileDetails ProfileDetails { get; set; }
        public List<MemberProgramDetail> ProgramDetails { get; set; }
    }
    ...
    public class MemberIndividualInfo
    {
        ...
        public List<MemberContactDetails> MemberContactInfos { get; set; }
    ...
    public class MemberDynamicAttribute
    {
    ...
    public class MemberProgramDetail
    {
