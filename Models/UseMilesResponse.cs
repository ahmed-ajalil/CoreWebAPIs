namespace CoreWebAPIs.Models
{
    ...
    public class Reward
    {
        ...
        public List<DynamicAttributes> DynamicAttributes { get; set; }
        public RewardPricingDetail RewardPricingDetail { get; set; }
    ...
    public class RewardPricingDetail
    {
